...
**Blog App** is a classic example of a blog website. I create a fully functional website that will show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
  cd my-folder
  git clone https://github.com/Al-Amin-Khan-Shakil/blog-app.git
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/blog-app/issues).
